...
expName = 'MentalNavigation_Day3'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/dexhrestha/Documents/Portfolio/neuronepal/neuronepal/psychopy/MentalNavigation_Day3.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    totalTime = 1*60 # total time before the experiment ends automatically 
    score = 0
    currentTrialDD = 0  
    devMode = True
    ...
    visualModeOptions = [True,False,False,True,True,False]
    ...
    for thisLastLoop in lastLoop:
        ...
        for thisBlockTrial in blockTrials:
            ...
            if thisSession is not None:
                # if running in a Session with a Liaison client, send data up to now
                thisSession.sendExperimentData()
        # completed 0.0 repeats of 'blockTrials'
