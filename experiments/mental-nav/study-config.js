export default {
  // Generic
  title: 'Mental Navigation Task',
  requirementsList: [
    'Standard mouse or trackpad and  keyboard',
    'Recently updated web browser',
  ],
  requirementsPara: [],
  summaryPara: [ 
    'Use your keyboard to move left or right to match the start and target landmarks. You must complete the experiment in fullscreen mode. Bonus payments based on your final score.',
  ],
  instructionsList: [
    'Start each trial with the cursor in the center.',
    'When a target appears, press and hold  the left or right key to move in left or right direction accordingly.',
    'Stop when the current landmark matches the target by releasing the key.',
  ],
  instructionsPara: [],
  ...
  prolific: {
    ...
    estimatedCompletionTime: 100, // minutes
    maximumAllowedTime: undefined, // default = 2 + 2*estimated + 2*sqrt(estimated)
    compatibleDevices: ['desktop'], // ['desktop', 'mobile', 'tablet']
