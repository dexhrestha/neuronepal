export default {
  // Generic
  title: 'Morse Code Reproduction Task',
  requirementsList: [
  ...
  requirementsPara: [],
  summaryPara: [
    'Use your keyboard to reproduce the morse code. You must complete the experiment in fullscreen mode. Bonus payments based on your final score.',
  ],
  instructionsList: [
    'Start each trial from the home position in the center. ',
    'Press Space key to generate the morse code',
    'When instuction appears, reproduce the morse code in the correct speed.',
  ],
  instructionsPara: [],
